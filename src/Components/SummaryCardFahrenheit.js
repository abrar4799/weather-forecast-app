...
function SummaryCardFahrenheit({day}) {
    let day_icon = `${process.env.REACT_APP_ICON_URL + day.weather[0]["icon"]}.png`       
    return (
        <li className="container p-4 flex items-center justify-center bg-gray-200 rounded-lg my-auto mr-1">
            <div className="my-auto">
                <p className="font-bold text-3xl text-pink-600 mb-2">{Math.round(day.main.temp)* 9 / 5 + 32}&deg;F</p>
...
export default SummaryCardFahrenheit